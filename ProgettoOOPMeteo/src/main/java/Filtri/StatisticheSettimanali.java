 ...
 * implementando la possibilita da parte del'utente di ricevere le statistiche delle citta in una settimana definita andando esclusivamente 
...
public class StatisticheSettimanali extends StatisticheAScelta{
	...
	/**
	 * costruttore della classe permette di passare aumomaticamente i valori di inizio e fine della classe StatisticheAScelta passando il valore della settiamana
	 *
	 * @param settimana
